...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black p-4 flex items-center justify-center">
      <div className="w-[90vw] md:w-full md:max-w-md min-h-[80vh] md:min-h-fit bg-zinc-900 rounded-3xl border border-zinc-800 shadow-[0_8px_32px_-4px_rgba(255,0,255,0.1)]">
        ...
        <form className="p-6 space-y-4 flex flex-col h-[calc(80vh-10rem)] md:h-auto">
          ...
          <div className="flex gap-4 mt-auto">
            <button
              type="button"
              className="flex-1 h-14 md:h-12 flex items-center justify-center gap-2 bg-white rounded-xl text-black text-lg md:text-base"
            >
              🎤 Record
            </button>
            ...
            <button
              type="submit"
              className="flex-1 h-14 md:h-12 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 text-white text-lg md:text-base"
            >
              Refine
            </button>
          </div>
